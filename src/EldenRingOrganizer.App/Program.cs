...
public static class Program
{
    ...
    public static unsafe int Main(string[] args)
    {
        ...
        if (RegulationIndexCommand.IsCommand(args))
        {
            return RegulationIndexCommand.Run(args);
        }
    ...
    private static unsafe void Run()
    {
        ...
        GlfwWindowPtr window = GLFW.CreateWindow(1280, 800, "Elden Ring Organizer — 0.1E Semantic Index", null, null);
        if (window.IsNull)
        {
            GLFW.Terminate();
